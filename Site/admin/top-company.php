	...
	<div id="content">
			...
			<div class="content-module">
				...
				<div class="content-module-main">
					...
					<h2>บริษัทชั้นนำ<span class="right"><a href="#" class="add-button blue round">เพิ่ม</a></span></h2>
