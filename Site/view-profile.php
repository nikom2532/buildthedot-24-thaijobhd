...
<div id="wrapper">
    ...
    <div id="content" class="container_12">
    	<div id="content-profile">
            ...
            <h3 class="text-grey">วรวรรณ ชาญสวสัดิ์</h3>
            <div><img src="images/banner-2.png" width="144" height="143"></div>
            <br class="clear"/>
            <p class="grid_2">Lorem Ipsum</p>
            <p class="grid_8">Lorem Ipsum</p><br class="clear"/>
            ...
            <p class="grid_2">Lorem Ipsum</p>
            <p class="grid_2">Lorem Ipsum</p>
            <p class="grid_2">Lorem Ipsum</p><br class="clear"/>
            ...
            <p class="grid_2">บุคคลที่ติดต่อได้</p>
            <p class="grid_2">Lorem Ipsum</p>
            <p class="grid_3">Lorem Ipsum</p><br class="clear"/>
            
            <p class="grid_2 prefix_2">Lorem Ipsum</p>
            <p class="grid_2">Lorem Ipsum</p><br class="clear"/>
            ...
            <div class="prefix_2">
            	<div class="grid_9" id="table-content">
                    <p class="grid_2 center">Lorem Ipsum</p>
                    <p class="grid_3 center">จุฬาลงกรณ์มหาวิทยาลัย</p>
                    <p class="grid_1 center">1111-1111</p>
                    <p class="grid_2 center">ปริญญาตรี</p>
                </div>
            </div><br class="clear"/>
            ...
            <p class="grid_2">ทักษะด้านภาษา</p><br class="clear"/>
            <div class="prefix_2">
            	<div id="head-table1" class="grid_9">
                    <p class="grid_2 center">Lorem Ipsum</p>
                    <p class="grid_2 center">Lorem Ipsum</p>
            ...
            <p class="grid_2">ความสามารถพิเศษ</p><br class="clear"/>
             <div class="prefix_2">
             		<p class="grid_4">Lorem Ipsum</p><br class="clear"/>
                    <p class="grid_4">Lorem Ipsum</p>
             </div>
      	</div>	
    </div><!--end content -->
